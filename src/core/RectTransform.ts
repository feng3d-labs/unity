namespace feng3d.unity
{
    ...
    export class RectTransform extends Transform
    {
         ...
         */
        GetLocalCorners(fourCornersArray: Vector3[])
        {
         ...
         */
        GetWorldCorners(fourCornersArray: Vector3[])
        {
         ...
         * 
         */
        SetInsetAndSizeFromParentEdge(edge: RectTransform.Edge, inset: number, size: number)
        {
         ...
         */
        SetSizeWithCurrentAnchors(axis: RectTransform.Axis, size: number)
        {
...
namespace feng3d.unity.RectTransform
{
    /**
