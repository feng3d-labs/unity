...
export class AnimatorState
{
     ...
     *
     * @param _defaultExitTime If true, the exit time will be the equivalent of 0.25 second.
     */
    AddExitTransition(_defaultExitTime: boolean)
    {
     ...
     */
    AddStateMachineBehaviour(_stateMachineBehaviourType: new () => any)
    {
     ...
     *
     * @param _destinationState The destination state | machine.
     * @param _defaultExitTime If true, the exit time will be the equivalent of 0.25 second.
     */
    AddTransition(_destinationState: AnimatorState | AnimatorStateMachine | AnimatorStateTransition, _defaultExitTime: boolean)
    {
